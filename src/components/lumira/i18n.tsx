...
const en: Dict = {
  ...
  "mirror.ar.autoAlign.btn": "Auto-Align",
  "mirror.ar.autoAlign.scanning": "Scanning…",
  "mirror.ar.autoAlign.title": "Detect face and snap to best preset",
  "mirror.ar.autoAlign.locked": "Locked to {preset} · {source}",
  "mirror.ar.autoAlign.srcFace": "face detected",
  "mirror.ar.autoAlign.srcLuma": "estimated",
  "mirror.ar.autoAlign.noFace": "No face detected — move closer to the camera",
  "mirror.ar.autoAlign.noPreset": "No preset available for this overlay",
  "mirror.ar.autoAlign.error": "Auto-align failed",
...
const ar: Dict = {
  ...
  "mirror.ar.autoAlign.btn": "محاذاة تلقائية",
  "mirror.ar.autoAlign.scanning": "جاري المسح…",
  "mirror.ar.autoAlign.title": "اكتشاف الوجه والالتقاط لأفضل إعداد",
  "mirror.ar.autoAlign.locked": "تم التثبيت على {preset} · {source}",
  "mirror.ar.autoAlign.srcFace": "تم اكتشاف الوجه",
  "mirror.ar.autoAlign.srcLuma": "تقديري",
  "mirror.ar.autoAlign.noFace": "لم يتم اكتشاف وجه — اقترب من الكاميرا",
  "mirror.ar.autoAlign.noPreset": "لا يوجد إعداد متاح لهذه الطبقة",
  "mirror.ar.autoAlign.error": "فشلت المحاذاة التلقائية",
