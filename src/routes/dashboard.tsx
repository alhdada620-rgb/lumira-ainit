...
function DashboardShell() {
  ...
  // Eligibility = authenticated Pioneer (non-demo). For real KYC verification,
  // pi_identities.kyc_verified would be used; for now treat real Pi users as KYC-eligible.
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-5">
          <Link to="/" className="text-[10px] tracking-[0.3em] text-slate-400 hover:text-teal-300 transition">
            ← LUMIRA
          </Link>
